...
RSpec.describe "Posters queries", type: :model do
  it 'returns posters in descending order by created_at time' do
    ...
    Poster.create(name: "MEDIOCRITY",description: "Dreams are just that—dreams.",price: 90.00,year: 2021,vintage: false,img_url: "https://t3.ftcdn.net/jpg/10/94/43/46/240_F_1094434660_eWqgET75FkLFBMKBz7kd5E3dYIM7tgpO.jpg")
    Poster.create(name: "MEDIOCRITY",description: "Dreams are just that—dreams.",price: 55.00,year: 2021,vintage: false,img_url: "https://t3.ftcdn.net/jpg/10/94/43/46/240_F_1094434660_eWqgET75FkLFBMKBz7kd5E3dYIM7tgpO.jpg")
